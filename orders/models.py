...
class Order(models.Model):
    ...
    billing_address = models.ForeignKey(BillingAddress, related_name= "billing_address", blank=True, null=True, on_delete=models.PROTECT)
    shipping_address = models.ForeignKey(UserAddress,related_name= "shipping_address", blank=True, null=True, on_delete=models.PROTECT)
